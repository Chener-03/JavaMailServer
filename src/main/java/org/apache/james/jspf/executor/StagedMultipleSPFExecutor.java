...
public class StagedMultipleSPFExecutor implements SPFExecutor, Runnable {
    ...
    private static class ResponseQueueImpl extends LinkedList implements IResponseQueue {
        ...
        /**
         * @see IResponseQueue#insertResponse(IResponse)
         */
        ...
        /**
         * @see IResponseQueue#removeResponse()
         */
    ...
    private synchronized void invokeAsynchService(SPFSession session,
        ...
        int nextId = nextId();
        sessions.put(Integer.valueOf(nextId), session);
        results.put(Integer.valueOf(nextId), result);
