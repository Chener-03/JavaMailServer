...
public class DNSServiceXBillImpl implements DNSService {
     ...
     * Default Constructor
     */
    public DNSServiceXBillImpl(Logger logger,String dnsAddress) {
    ...
    /**
     * @see DNSService#getLocalDomainNames()
     */
    ...
    /**
     * @see DNSService#getRecords(DNSRequest)
     */
    public List getRecords(DNSRequest request)
        ...
        try {
            ...
            if (dnsAddress != null) {
                SimpleResolver r = new SimpleResolver(dnsAddress);
                r.setPort(53);
                query.setResolver(r);
            }
